...
class InsightCustomerRead(BaseModel):
    customer_id: int
    gender: str
    age: int
    city: str
...
class InsightComplaintCategoryRead(BaseModel):
    id: int
...
class InsightComplaintRead(BaseModel):
    complaint_id: int
    customer_id: int
    ...
    @field_serializer("complaint_time")
    def _serialize_complaint_time(self, value: datetime) -> datetime:
        return _as_utc_aware(value)


class InsightSurveyRead(BaseModel):
    id: int
    customer_id: int
    survey_date: date
    network_score: int
...
class InsightRiskPredictionRead(BaseModel):
    id: int
    customer_id: int
    risk_score: float
    ...
    @field_serializer("predict_time")
    def _serialize_predict_time(self, value: datetime) -> datetime:
        return _as_utc_aware(value)
