...
_VALID = {c for c, _ in CORPUS_CATEGORIES}

_KEYWORD_HINTS: tuple[tuple[str, tuple[str, ...]], ...] = (
...
def normalize_category(value: str | None) -> str:
    ...
    return key if key in _VALID else DEFAULT_CATEGORY
...
def suggest_category(question: str) -> dict[str, str | float]:
    ...
    best_score = 0
    for cat, words in _KEYWORD_HINTS:
