...
from app.services.modules.complaint_categories import CATEGORY_SEEDS, dumps_seed_phrases
from app.services.modules.complaint_category_namer import suggest_complaint_category
    ...
    def search_samples(
        ...
        *,
        ...
        scored_rows, total = crud.search_complaints(
            self.db,
            address=address,
            text=None if query_vector is not None else (query_text or None),
            time_from=time_from,
            time_to=time_to,
